...
//  Translator
//
//  Created by mert sağlam on 16.07.2023.
//
...
class TranslationManager: NSObject {
    ...
    internal func makeRequest(usingTranslationAPI api: TranslationAPI, urlParams: [String: String], completion: @escaping (_ results: [String: Any]?) -> Void) {
